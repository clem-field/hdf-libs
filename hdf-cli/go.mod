...
require (
	...
	github.com/mitre/hdf-libs/hdf-converters/v3 v3.3.2
	github.com/mitre/hdf-libs/hdf-diff/go/v3 v3.3.2
	github.com/mitre/hdf-libs/hdf-generators/go/v3 v3.3.2
